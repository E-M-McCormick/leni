...
example can be seen below.
    ...
    nu.1 == yN_m - (betaN_m * d_m/3) * (((0 - xN_m)/d_m)^3 - 3 * ((0 - xN_m)/d_m));
    nu.2 == yN_m - (betaN_m * d_m/3) * (((1 - xN_m)/d_m)^3 - 3 * ((1 - xN_m)/d_m));
    nu.4 == yN_m - (betaN_m * d_m/3) * (((3 - xN_m)/d_m)^3 - 3 * ((3 - xN_m)/d_m));
    nu.8 == yN_m - (betaN_m * d_m/3) * (((7 - xN_m)/d_m)^3 - 3 * ((7 - xN_m)/d_m));
    nu.14 == yN_m - (betaN_m * d_m/3) * (((13 - xN_m)/d_m)^3 - 3 * ((13 - xN_m)/d_m));
    nu.24 == yN_m - (betaN_m * d_m/3) * (((23 - xN_m)/d_m)^3 - 3 * ((23 - xN_m)/d_m));

    xN.1 == (betaN_m * d_m/3) * (3 * (1/d_m * ((0 - xN_m)/d_m)^2) - 3 * (1/d_m));
    xN.2 == (betaN_m * d_m/3) * (3 * (1/d_m * ((1 - xN_m)/d_m)^2) - 3 * (1/d_m));
    xN.4 == (betaN_m * d_m/3) * (3 * (1/d_m * ((3 - xN_m)/d_m)^2) - 3 * (1/d_m));
    xN.8 == (betaN_m * d_m/3) * (3 * (1/d_m * ((7 - xN_m)/d_m)^2) - 3 * (1/d_m));
    xN.14 == (betaN_m * d_m/3) * (3 * (1/d_m * ((13 - xN_m)/d_m)^2) - 3 * (1/d_m));
    xN.24 == (betaN_m * d_m/3) * (3 * (1/d_m * ((23 - xN_m)/d_m)^2) - 3 * (1/d_m));
    ...
    d.1 == -(betaN_m/3 * (((0 - xN_m)/d_m)^3 - 3 * ((0 - xN_m)/d_m)) - (betaN_m * d_m/3) * (3 * ((0 - xN_m)/d_m^2 * ((0 - xN_m)/d_m)^2) - 3 * ((0 - xN_m)/d_m^2)));
    d.2 == -(betaN_m/3 * (((1 - xN_m)/d_m)^3 - 3 * ((1 - xN_m)/d_m)) - (betaN_m * d_m/3) * (3 * ((1 - xN_m)/d_m^2 * ((1 - xN_m)/d_m)^2) - 3 * ((1 - xN_m)/d_m^2)));
    d.4 == -(betaN_m/3 * (((3 - xN_m)/d_m)^3 - 3 * ((3 - xN_m)/d_m)) - (betaN_m * d_m/3) * (3 * ((3 - xN_m)/d_m^2 * ((3 - xN_m)/d_m)^2) - 3 * ((3 - xN_m)/d_m^2)));
    d.8 == -(betaN_m/3 * (((7 - xN_m)/d_m)^3 - 3 * ((7 - xN_m)/d_m)) - (betaN_m * d_m/3) * (3 * ((7 - xN_m)/d_m^2 * ((7 - xN_m)/d_m)^2) - 3 * ((7 - xN_m)/d_m^2)));
    d.14 == -(betaN_m/3 * (((13 - xN_m)/d_m)^3 - 3 * ((13 - xN_m)/d_m)) - (betaN_m * d_m/3) * (3 * ((13 - xN_m)/d_m^2 * ((13 - xN_m)/d_m)^2) - 3 * ((13 - xN_m)/d_m^2)));
    d.24 == -(betaN_m/3 * (((23 - xN_m)/d_m)^3 - 3 * ((23 - xN_m)/d_m)) - (betaN_m * d_m/3) * (3 * ((23 - xN_m)/d_m^2 * ((23 - xN_m)/d_m)^2) - 3 * ((23 - xN_m)/d_m^2)));

    betaN.1 == -(d_m/3 * (((0 - xN_m)/d_m)^3 - 3 * ((0 - xN_m)/d_m)));
    betaN.2 == -(d_m/3 * (((1 - xN_m)/d_m)^3 - 3 * ((1 - xN_m)/d_m)));
    betaN.4 == -(d_m/3 * (((3 - xN_m)/d_m)^3 - 3 * ((3 - xN_m)/d_m)));
    betaN.8 == -(d_m/3 * (((7 - xN_m)/d_m)^3 - 3 * ((7 - xN_m)/d_m)));
    betaN.14 == -(d_m/3 * (((13 - xN_m)/d_m)^3 - 3 * ((13 - xN_m)/d_m)));
    betaN.24 == -(d_m/3 * (((23 - xN_m)/d_m)^3 - 3 * ((23 - xN_m)/d_m)));
